...
import directory.mastodoninstances.backend.integration.database.mongodb.codecs.InstanceHousekeepingCodecProvider
import directory.mastodoninstances.backend.integration.database.mongodb.codecs.InstanceCodecProvider
import directory.mastodoninstances.backend.integration.database.mongodb.codecs.InstanceLocationCodec
import directory.mastodoninstances.backend.integration.database.mongodb.codecs.InstanceSecurityCodec
import directory.mastodoninstances.backend.integration.database.mongodb.codecs.InstanceStatsCodec
import directory.mastodoninstances.backend.integration.database.mongodb.codecs.LastCheckResultCodec
    ...
    fun mongoClient(): MongoClient {
        ...
        val codecRegistry = fromRegistries(
                    fromCodecs(
                        ...
                        InstanceStatsCodec(),
                        InstanceLocationCodec(),
                        InstanceSecurityCodec()
                    ),
                    fromProviders(
